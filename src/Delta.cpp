...
struct DeltaWidget : ModuleWidget {
	DeltaWidget(Delta* module) {
		...
		addParam(createParamCentered<MedHexKnob>(mm2px(Vec(25.4, 63.413)), module, Delta::MANUALCLOCK_PARAM));
		addParam(createParamCentered<MedHexKnob>(mm2px(Vec(15.24, 88.732)), module, Delta::RMLGATEMANUAL_PARAM));
		addParam(createParamCentered<MedHexKnob>(mm2px(Vec(25.4, 88.732)), module, Delta::RMLGATEHOLD_PARAM));
		addParam(createParamCentered<MedHexKnob>(mm2px(Vec(15.24, 98.892)), module, Delta::LMRGATEMANUAL_PARAM));
		addParam(createParamCentered<MedHexKnob>(mm2px(Vec(25.4, 98.892)), module, Delta::LMRGATEHOLD_PARAM));
